...
O questionário apresenta várias afirmações e pede apenas que o utilizador indique o seu nível de concordância ou discordância. No final, o site estima o peso relativo das tuas opiniões dentro de nove eixos ideológicos.
...
Se quiseres evoluir o projeto e torná-lo mais interessante, aqui ficam sugestões práticas:
...
2. **Perfis de comparação**
   * Permitir comparar o resultado com médias por país, idade ou perfil político de referência.
